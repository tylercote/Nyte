import {
    ...
    FB_LOGIN_ERROR,
    FB_LOGIN_START,
    FB_PROFILE_ERROR, GET_DESTINATION_DATA_ERROR,
...
function rootReducer(state = initialState, action) {
    ...
    switch (action.type) {
        case RECEIVE_FB_PROFILE:
            return Object.assign({}, state, {fbToken: action.payload.token, userProfile: action.payload});
        ...
        case GET_DESTINATION_DATA_RECEIVED:
            ...
            return Object.assign({}, state, {destinationData: action.payload});
